...
import '../volunteer/addvolunteer.dart';

class OurEventsPage extends StatefulWidget {
  VoidCallback voidCallback;
  OurEventsPage({required this.voidCallback});

  @override
  _OurEventsPageState createState() => _OurEventsPageState();
}

class _OurEventsPageState extends State<OurEventsPage> with HappyExtensionHelper  implements HappyExtensionHelperCallback{
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text('Our Events',style: TextStyle(color:ColorUtil.themeBlack,fontFamily: 'RB',fontSize: 24),),
                              ),
                              Container(
                                padding: const EdgeInsets.only(left: 10.0,),
