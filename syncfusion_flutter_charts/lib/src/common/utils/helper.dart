...
import 'package:syncfusion_flutter_charts/syncFlutterCore/src/legend/legend.dart' as le;
  ...
  if (!chartLegend.shouldRenderLegend) {
    ...
    if (legend.legendItemBuilder != null) {
      ...
      element = le.SfLegend(
          ...
          width: legendWidth,
          height: legendHeight,
          onItemRenderer: (le.ItemRendererDetails args) {
...
le.LegendPosition getEffectiveChartLegendPosition(
    LegendPosition position) {
  switch (position) {
    case LegendPosition.top:
      return le.LegendPosition.top;
    case LegendPosition.bottom:
      return le.LegendPosition.bottom;
    case LegendPosition.left:
      return le.LegendPosition.left;
    case LegendPosition.right:
      return le.LegendPosition.right;
    default:
      return le.LegendPosition.bottom;
  }
}
...
le.LegendAlignment getEffectiveLegendAlignment(ChartAlignment alignment) {
  le.LegendAlignment legendAlignment;
  switch (alignment) {
    case ChartAlignment.near:
      legendAlignment = le.LegendAlignment.near;
      break;
    case ChartAlignment.far:
      legendAlignment = le.LegendAlignment.far;
      break;
    case ChartAlignment.center:
      legendAlignment = le.LegendAlignment.center;
      break;
  }
...
le.LegendOverflowMode getEffectiveLegendItemOverflowMode(
    LegendItemOverflowMode overflowMode, ChartLegend chartLegend) {
  le.LegendOverflowMode mode;
  switch (overflowMode) {
    case LegendItemOverflowMode.wrap:
      if (chartLegend.isNeedScrollable) {
        mode = le.LegendOverflowMode.wrapScroll;
      } else {
        mode = le.LegendOverflowMode.wrap;
      }
      break;
    case LegendItemOverflowMode.scroll:
      mode = le.LegendOverflowMode.scroll;
      break;
    case LegendItemOverflowMode.none:
      mode = le.LegendOverflowMode.none;
      break;
  }
  return mode;
}
